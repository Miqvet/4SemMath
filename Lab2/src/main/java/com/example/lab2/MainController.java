...
public class MainController implements Initializable {
    ...
    @FXML
    public TextField systemFileName;
    @FXML
    ...
    public void getExpressionDataFromFile(ActionEvent event){
        Scanner scanner;
        try {
            scanner = new Scanner(new File("src/main/resources/com/example/lab2/" + fileName1.getText()));
    ...
    public void getSystemDataFromFile(ActionEvent event){
        ...
        try {
            scanner = new Scanner(new File("src/main/resources/com/example/lab2/" + systemFileName.getText()));
